...
def main():
    ...
    summary_template = """Given the information {info} about a person, I want you to create:
    ...
    # llm  = ChatOllama(temperature=0, model="gemma3:27b")
    chain = summary_prompt_template | llm
    response = chain.invoke({"info": information})
    print(response)
